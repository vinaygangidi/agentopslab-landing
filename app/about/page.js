...
const journey = [
  ...
  },
  {
    ...
    bg: '#EEF2FF',
    border: '#C7D2FE',
    title: 'Synopsys: from RPA to agentic AI, and what I learned building both',
    body: "The most important shift in my career happened around 2022 when I moved from orchestrating bots to orchestrating AI agents. At Synopsys I built LangChain-based agentic workflows on n8n for AR and HR, deployed GPT-4 document intelligence across the Procure-to-Pay cycle, and designed the AI governance framework that ensured we scaled responsibly. I also learned where the new failure modes live: an AI agent can return a confident, well-formed answer that is simply wrong for the situation — no error thrown, nothing in the logs. That drove how I now think about governance, observability, and the non-negotiable role of the human in the loop.",
    tech: ['Azure AI Foundry', 'LangChain', 'GPT-4', 'Azure Document Intelligence', 'n8n', 'Snowflake', 'UiPath'],
  },
];
...
const signatureWork = [
  {
    title: 'Built the AI & Automation Center of Excellence at Synopsys from scratch',
  ...
  {
    title: 'Designed the AI Governance and Security Framework for enterprise AI at Synopsys',
    outcome: 'Policy adopted enterprise-wide, covering standards, guardrails, and responsible AI use across all functions',
    what: "Partnered with Engineering and Security to define what responsible AI use looks like in a semiconductor IP company where data governance and IP protection are non-negotiable. Covered model selection, data handling, output validation, audit requirements, and incident response for AI-specific failure modes.",
    color: '#7C3AED',
    border: '#C4B5FD',
    bg: '#F5F3FF',
  },
  {
    title: 'Deployed LangChain agentic workflows on n8n for Accounts Receivable and HR',
    outcome: 'First production agentic AI deployment at Synopsys — multi-step reasoning with human escalation paths',
    what: "Moved the team from single-call AI to multi-step agent workflows that could plan, use tools, and hand off to a human when confidence dropped below threshold. Built on n8n with LangChain for the reasoning layer. This became the reference architecture for subsequent agent deployments.",
    color: '#0891B2',
    border: '#BAE6FD',
    bg: '#E0F2FE',
  },
  {
    title: 'Led the Document Intelligence Center of Excellence at Autodesk',
    outcome: '70% reduction in invoice, PO, and contract processing time across the Finance organization',
    what: "Founded the CoE, hired and mentored the team, and designed the platform architecture for document AI at Autodesk. Built on Azure Document Intelligence integrated with the SAP and Oracle ERP systems. Reduced a 3-day manual review cycle to same-day automated processing with exception-only human review.",
    color: '#059669',
    border: '#A7F3D0',
    bg: '#ECFDF5',
  },
  ...
  return (
    <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", background: '#F8FAFC', color: '#0F172A', minHeight: '100vh' }}>
      ...
      <section style={{ maxWidth: '1200px', margin: '0 auto', padding: '64px 28px 64px' }}>
        <div className="hero-grid" style={{ display: 'grid', gridTemplateColumns: '320px 1fr', gap: '64px', alignItems: 'center' }}>

          {/* Large photo column */}
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '20px' }}>
            <div className="photo-hero" style={{ width: '300px', height: '340px', borderRadius: '24px', overflow: 'hidden', boxShadow: '0 24px 64px rgba(79,70,229,0.18), 0 4px 16px rgba(0,0,0,0.10)', border: '4px solid #fff' }}>
              <img src="/vinay.jpeg" alt="Vinay Gangidi" style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center top' }} />
            </div>
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontWeight: '800', fontSize: '18px', color: '#0F172A', marginBottom: '4px' }}>Vinay Gangidi</div>
              <div style={{ fontSize: '13px', color: '#64748B', marginBottom: '12px' }}>Morrisville, NC · Open to advisory roles</div>
          ...
          {/* Text column */}
          <div>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', fontFamily: 'JetBrains Mono, monospace', fontSize: '11px', letterSpacing: '.14em', textTransform: 'uppercase', color: '#059669', background: '#ECFDF5', border: '1px solid #A7F3D0', padding: '5px 12px', borderRadius: '100px', marginBottom: '24px' }}>
              <span style={{ width: '6px', height: '6px', borderRadius: '50%', background: '#059669', display: 'inline-block' }} />
              Enterprise AI Architect · 15 years in production
            </div>
            <h1 style={{ fontWeight: '800', fontSize: 'clamp(36px,4.5vw,56px)', lineHeight: '1.06', letterSpacing: '-.025em', marginBottom: '20px', color: '#0F172A' }}>
              I bridge strategy<br />and architecture.
            </h1>
            <p style={{ fontWeight: '600', fontSize: 'clamp(16px,2vw,19px)', color: '#4F46E5', lineHeight: '1.5', maxWidth: '52ch', marginBottom: '20px' }}>
              Senior Manager, Enterprise Solution Architect (Automation & AI) · Synopsys, Inc
            </p>
            <p style={{ color: '#475569', fontSize: '16px', lineHeight: '1.8', maxWidth: '58ch', marginBottom: '20px' }}>
              I can design your enterprise AI roadmap in the morning and review the agent code in the afternoon. I have built both, and I know which conversations need which language.
            </p>
            <p style={{ color: '#64748B', fontSize: '15px', lineHeight: '1.8', maxWidth: '58ch', marginBottom: '36px' }}>
              15 years building AI and automation across Finance, HR, GTM, Legal, and Operations. Led a global 12-person AI Center of Excellence at Synopsys and delivered $1M+ in annual savings and 15,000+ productivity hours across the enterprise.
            </p>
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px' }}>
              <a href="mailto:vinay.gangidi@gmail.com" style={{ display: 'inline-flex', alignItems: 'center', gap: '7px', padding: '12px 24px', background: 'linear-gradient(135deg,#6366f1,#4f46e5)', color: '#fff', borderRadius: '9px', fontSize: '14px', fontWeight: '700', textDecoration: 'none', boxShadow: '0 4px 14px rgba(99,102,241,0.3)' }}>
                <Mail size={14} /> vinay.gangidi@gmail.com
              </a>
              <a href="tel:+15167075282" style={{ display: 'inline-flex', alignItems: 'center', gap: '7px', padding: '12px 24px', background: '#fff', border: '1px solid #E2E8F0', color: '#0F172A', borderRadius: '9px', fontSize: '14px', fontWeight: '600', textDecoration: 'none' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            <div className="stats-row" style={{ display: 'grid', gridTemplateColumns: 'repeat(2,1fr)', gap: '12px' }}>
              {[
                ...
                { val: '100+', label: 'Automation solutions built', color: '#4F46E5', bg: '#EEF2FF' },
                { val: '15+', label: 'AI solutions in production', color: '#D97706', bg: '#FFFBEB' },
              ].map(({ val, label, color, bg }) => (
                <div key={label} style={{ background: bg, borderRadius: '12px', padding: '18px', textAlign: 'center' }}>
                  <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: '700', fontSize: '28px', color, marginBottom: '4px' }}>{val}</div>
                  <div style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: '9px', color: '#64748B', textTransform: 'uppercase', letterSpacing: '.08em', lineHeight: '1.5' }}>{label}</div>
                </div>
              ))}
            </div>
            <div style={{ background: '#fff', border: '1px solid #E2E8F0', borderRadius: '12px', padding: '20px' }}>
              <div style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: '10px', color: '#94A3B8', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: '10px' }}>Current role</div>
              <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: '700', fontSize: '15px', marginBottom: '3px' }}>Synopsys, Inc</div>
              <div style={{ fontSize: '13px', color: '#475569', lineHeight: '1.5', marginBottom: '8px' }}>Senior Manager, Enterprise Solution Architect (Automation & AI)</div>
              <div style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: '11px', color: '#94A3B8' }}>Morrisville, NC · Oct 2020 — Present</div>
            </div>
            <div style={{ background: '#F8FAFC', border: '1px solid #E2E8F0', borderRadius: '12px', padding: '20px' }}>
              <div style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: '10px', color: '#94A3B8', textTransform: 'uppercase', letterSpacing: '.1em', marginBottom: '10px' }}>Available for</div>
              {['Advisory engagements', 'Speaking and panels', 'Leadership roles', 'AI strategy consulting'].map(item => (
                <div key={item} style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '5px 0' }}>
      ...
      <section style={{ background: '#fff', borderTop: '1px solid #E2E8F0', borderBottom: '1px solid #E2E8F0', padding: '80px 28px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <h2 style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: '700', fontSize: 'clamp(26px,3vw,38px)', letterSpacing: '-.02em', marginBottom: '12px' }}>Not a resume. A progression of thinking.</h2>
      ...
      <section style={{ maxWidth: '1200px', margin: '0 auto', padding: '80px 28px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '12px', marginBottom: '32px' }}>
          {[
            { name: 'UiPath Agentic Automation Engineer', cat: 'AI & Automation', color: '#4F46E5', bg: '#EEF2FF' },
            { name: 'Microsoft Azure AI Associate Engineer', cat: 'AI & Automation', color: '#4F46E5', bg: '#EEF2FF' },
