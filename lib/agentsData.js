...
export const techBadges = {
  ...
  azure:  { label: 'Azure OpenAI',    color: '#60A5FA', bg: 'rgba(96,165,250,0.10)',  border: 'rgba(96,165,250,0.28)'  },
};
    ...
    subFunctions: [
      {
        ...
        agents: [
          ...
          },
          {
            icon: 'Brain',
            name: 'Marginalia',
            desc: 'Remembers each deal across sessions and retires stale facts on time',
            tag: 'Persistent memory',
            tech: 'azure',
            github: 'https://github.com/vinaygangidi/AgentOpsLab/blob/main/agents/sales/marginalia_agent.py',
          },
        ],
      },
      {
